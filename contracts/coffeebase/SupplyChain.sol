...
//Import contracts to inherit from
...
contract SupplyChain is Ownable,FarmerRole,DistributorRole,RetailerRole,ConsumerRole{
  ...
  function harvestItem(
    uint _upc, address _originFarmerID, string memory _originFarmName, string memory _originFarmInformation, 
  ...
  function refundBuyer(uint _amountToReturn) public payable {
   payable(msg.sender).transfer(_amountToReturn);
  }
}
